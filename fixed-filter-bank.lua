...
function init_params()
   params:add_taper('amp0', "amp0", 0, 1, 0.3)
   params:set_action('amp0', function(v) engine.amp0(v) end)

   params:add_taper('amp1', "amp1", 0, 1, 0)
   ...
   params:add_taper('amp3', "amp3", 0, 1, 0)
   ...
   params:add_taper('amp6', "amp6", 0, 1, 0)
...
function draw_text()
   ...
   screen.font_size(20)
   screen.level(5)
   screen.text_center_rotate(WIDTH/2, HEIGHT/2+5, "fixed", 35)
   screen.stroke()
end
